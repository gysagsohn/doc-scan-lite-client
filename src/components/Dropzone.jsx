...
const RATE_LIMIT_MS = 5000; // 5 seconds between uploads
  ...
  const onSelect = useCallback(async (file) => {
    ...
    try {
      ...
      if (file.type === "application/pdf") {
        ...
        // Reduce to 800px to minimize tokens (OpenAI charges per 512px tile)
      ...
      if (totalPayloadSize > 10 * 1024 * 1024) { // 10MB limit
      ...
      // Always use relative URL - Netlify Dev will proxy it correctly
        ...
        <div style={{ 
          ...
          {result.duplicate && (
            <p style={{ 
              ...
              ⚠️ <strong>Duplicate detected:</strong> This file was uploaded within the last 7 days.
            </p>
          )}
...
async function resizeImage(dataUrl, maxDimension = 800) {
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      // Calculate new dimensions - ALWAYS recompress to JPEG
      ...
      // ALWAYS convert to JPEG with 70% quality for maximum compression
